@ST_41047 @tagtagtag @this_is_story_tag
...
@SC_155562 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_155563 @third_scenario_tag
...
@SC_155564 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_155565 @fifth_scenario_tag
