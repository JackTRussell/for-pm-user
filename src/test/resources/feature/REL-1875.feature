@ST_41046 @tagtagtag @this_is_story_tag @new_changes
...
@SC_155552 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_155553 @third_scenario_tag
...
@SC_155554 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_155555 @fifth_scenario_tag
...
@SC_155558 @fourth_scenario_tag
Scenario: Fourth scenario
Some description J
Given I created scenario
Then I see it in Relime

@SC_155559 @fifth_scenario_tag
Scenario Outline: Fifth scenario
Given the salary management system is initialized with the following data
When the boss increases the salary for the <user> with id <id> by 5%
Then the payroll for the employee with <id> should display a salary of <salary>
